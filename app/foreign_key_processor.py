...
class ForeignKeyProcessor:
    ...
    def set_foreign_keys(conversion):
        ...
        ConcurrencyManager.run_concurrently(conversion, ForeignKeyProcessor._get_foreign_keys_metadata, params)
    ...
    def _set_foreign_keys_for_given_table(conversion, table_name, rows):
        ...
        ConcurrencyManager.run_concurrently(conversion, ForeignKeyProcessor._set_single_foreign_key, params)
