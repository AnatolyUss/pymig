...
class DataLoader:
    ...
    def _arrange_and_load_batch(
        ...
        :return: None
        """
        log_title = f'{DataLoader._arrange_and_load_batch.__name__}'
        ...
        try:
            ...
            msg = (f'\t--[{log_title}] For now inserted: {number_of_inserted_rows} rows, '
            ...
            msg = 'Data retrieved by following MySQL query has been rejected by the target PostgreSQL server.'
            FsOps.generate_error(conversion, f'\t--[{log_title}] {e}\n\t--[{log_title}] {msg}')
